...
lv_textarea_set_max_length(ui_aeLandingBottomLabel, 19);
...
lv_obj_set_x( ui_aeLandingBottomIcon, -30 );
lv_obj_set_y( ui_aeLandingBottomIcon, -15 );
lv_obj_set_align( ui_aeLandingBottomIcon, LV_ALIGN_LEFT_MID );
